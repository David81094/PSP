...
public class Cuenta {
    ...
    // Metodos
    public synchronized void ingresar(int cantidad, int turno, Persona ultimoCliente) throws InterruptedException {
        bandera[turno] = true;
    ...
    public synchronized void retirar(int cantidad, int turno, Persona ultimoCliente) throws InterruptedException {
        bandera[turno] = true;
    ...
    private void seccionCriticaIngreso(int cantidad, Persona ultimoCliente) throws InterruptedException {
    ...
    private void seccionCriticaRetirada(int cantidad, Persona ultimoCliente) throws InterruptedException {
